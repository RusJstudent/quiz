...
let question3 = `Всего 6 континентов: Северная и <br>Южная америка,
Евразия, Африка, <br>Австралия и Антарктида.<br><br>
Переходим к более сложным вопросам:<br>
Какая фигура в шахматах <br>завершает комбинацию "мат Легаля?"`;
let question4 = `Последняя задача:<br>
В 9-этажном доме есть лифт.<br>
На первом этаже живет 2 человека,<br>
на втором - 4 человека, <br>на третьем - 8 человек<br>
и так далее..<br>
Какая кнопка в лифте этого дома <br>нажимается чаще других?`;
